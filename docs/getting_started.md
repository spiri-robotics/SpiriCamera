...
when it was taken, what took it, and anything you care to add — see the
{doc}`exif` guide for how to read tags back, add your own (GPS included),
and share the tagging job between more than one piece of software.
